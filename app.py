...
def download_file():
    ...
    file_url = https://raw.githubusercontent.com/Bskn1411/files/main/hell/{file_name}
...
def view():
    file_name = request.form["file_name"]
    file_url = f"https://raw.githubusercontent.com/Bskn1411/files/main/contents/hell/{file_name}"
